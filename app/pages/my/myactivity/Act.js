...
export default class Act extends PureComponent {
    // 默认属性
    // 构造
    constructor(props) {
        super(props);
    ...
    render() {
        ...
        return (
            <SafeAreaView style={{flex:1,backgroundColor:'#f5f5f5'}}>
                <Title title={'我的活动'} onPressForward={this._onPressForward} forwardLabelText={deleteStatus?'取消':'编辑'} border forward  back onPressBack={this._back}/>
                <TabView
