...
export default class All extends PureComponent {
    ...
    _getAdList = (userInfo) => {
        ...
        let url = Config.requestUrl + Config.myAd.adList + `?mobile=${userInfo.mobile}&status=`;
                        ...
                        <View style={{flex: 1,}}>
                            ...
                            <View style={{justifyContent: 'flex-end', flex: 1}}>
                                <View style={{
                                    ...
                                    <Text style={{
                                        fontSize: moderateScale(12),
                                        color: item.launchStatus===0?"#ababab":item.launchStatus===1?"#eea04d":item.launchStatus===2?"#33b661":item.launchStatus===3?"#ed5345":"#ababab"
                                    }}>{item.launchStatus===0?'草稿':item.launchStatus===1?'准备投放':item.launchStatus===2?'正在投放':item.launchStatus===3?'暂停投放':'投放完成'}</Text>
                                </View>
                            </View>
                        </View>
                    </View>
