...
export default class UpdateEmail_2 extends PureComponent {
    // 默认属性
    // 构造
    constructor(props) {
        super(props);
    ...
    _updateEmail=()=>{
        ...
        this.setState({visible:true},()=>{
            let url = Config.requestUrl + Config.emailSettingPage.emailSetUrl +  `?newEmail=${email}&codeNumber=${verifyCode}&mobile=${mobile}`;
        ...
        return (
            <SafeAreaView style={{flex:1,backgroundColor:'#f5f5f5'}}>
                ...
                <View style={{
                    ...
                    <View style={{
                        ...
                        <View style={{flexDirection: 'row', alignItems: 'center'}}>
                            <Text style={{color: '#333', fontSize: moderateScale(14)}}>新邮箱地址</Text>
                            <Input style={{
                                height: px2dp(96),
                ...
                <View style={{paddingHorizontal: px2dp(90)}}>
                    <TouchableOpacity activeOpacity={0.75} onPress={this._updateEmail}>
                        <View style={{
