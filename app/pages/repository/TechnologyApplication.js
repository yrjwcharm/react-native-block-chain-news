...
export default class TechnologyApplication extends PureComponent {
    // 默认属性
    // 构造
    constructor(props) {
        super(props);
        ...
        this.state = {
            ...
            tagId:'',
            keyList:[
                {key:1908, value:'主要代币',checked:false},
                {key:1909, value:'加密货币',checked:false},
                {key:1910, value:'智能合约',checked:false},
            ]
        }
    ...
    _queryList=()=>{
        let url=Config.requestUrl+Config.repository.getDataList+`?channelIds=154&tagIds=${this.state.tagId}&channelOption=1&pageNumber=${this.state.page}`;
        console.log(999,url);
