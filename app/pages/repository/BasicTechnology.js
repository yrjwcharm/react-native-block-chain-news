...
export default class BasicTechnology extends PureComponent {
    // 默认属性
    // 构造
    constructor(props) {
        super(props);
        ...
        this.state = {
            ...
            tagId:'',
            keyList:[
                {key:1903, value:'共识机制',checked:false},
                {key:1904, value:'分布式存储',checked:false},
                {key:1905, value:'区块数据',checked:false},
                {key:1906, value:'链式结构',checked:false},
                {key:1907, value:'非加密对称',checked:false},
            ]
        }
    ...
    _queryList=()=>{
        let url=Config.requestUrl+Config.repository.getDataList+`?channelIds=153&tagIds=${this.state.tagId}&channelOption=1&pageNumber=${this.state.page}`;
        console.log(999,url);
