...
export default class TechnologyAdvanced extends PureComponent {
    // 默认属性
    // 构造
    constructor(props) {
        super(props);
        ...
        this.state = {
            ...
            tagId:'',
            keyList:[
                {key:1911, value:'工作证明与挖矿',checked:false},
                {key:1912, value:'时间戳服务与存在证明',checked:false},
                {key:1913, value:'比特币交易构成',checked:false},
            ]
        }
    ...
    _queryList=()=>{
        let url=Config.requestUrl+Config.repository.getDataList+`?channelIds=157&tagIds=${this.state.tagId}&channelOption=1&pageNumber=${this.state.page}`;
        console.log(999,url);
