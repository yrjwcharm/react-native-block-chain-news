...
export default class DigitalCurrencyTransactions extends PureComponent {
    // 默认属性
    // 构造
    constructor(props) {
        super(props);
        ...
        this.state = {
            ...
            tagId:'',
            keyList:[
                {key:1917, value:'交易',checked:false},
                {key:1918, value:'发行',checked:false},
                {key:1919, value:'工具',checked:false},
                {key:1920, value:'市场',checked:false},
                {key:1921, value:'挖矿',checked:false},
                {key:1922, value:'账户',checked:false},
            ]
        }
    ...
    _queryList=()=>{
        let url=Config.requestUrl+Config.repository.getDataList+`?channelIds=156&tagIds=${this.state.tagId}&channelOption=1&pageNumber=${this.state.page}`;
        console.log(999,url);
