...
export default class DerivativeTechnology extends PureComponent {
    // 默认属性
    // 构造
    constructor(props) {
        super(props);
        ...
        this.state = {
            ...
            tagId:'',
            keyList:[
                {key:1914, value:'主链扩容',checked:false},
                {key:1915, value:'其他技术',checked:false},
                {key:1916, value:'跨链协议',checked:false},
            ]
        }
    ...
    _queryList=()=>{
        let url=Config.requestUrl+Config.repository.getDataList+`?channelIds=155&tagIds=${this.state.tagId}&channelOption=1&pageNumber=${this.state.page}`;
        console.log(999,url);
