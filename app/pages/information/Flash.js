...
export default class Flash extends PureComponent {
    // 默认属性
    // 构造
    constructor(props) {
        super(props);
    ...
    _queryList=()=>{
        let url = Config.requestUrl + Config.informationPage.getDataList + `?channelIds=136,137,138,139,140&pageNumber=${this.state.page}`;
