...
export default class News extends PureComponent {
    ...
    _queryList=()=>{
        let url = Config.requestUrl + Config.informationPage.getDataList + `?channelIds=95&pageNumber=${this.state.page}`;
                            ...
                            <View style={{flex:1,justifyContent:'flex-end'}}>
                                <View style={{
                                    ...
                                    <View style={{flexDirection: 'row', alignItems: 'center',}}>
                                        ...
                                        <Text style={{
                                            marginLeft:StringUtils.isEmpty(item.author)?0:px2dp(20),
                                            fontFamily: "PingFangSC-Regular",
                                            fontSize: moderateScale(12),
                                            color: "#999999"
