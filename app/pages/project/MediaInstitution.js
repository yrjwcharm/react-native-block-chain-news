...
let itemNo=0;
export default class MediaInstitution extends PureComponent {
    // 默认属性
    // 构造
    constructor(props) {
        super(props);
    ...
    _queryList = () => {
        let url = Config.requestUrl + Config.projectNavigator.projectNavigatorList + `?channelIds=164&pageNumber=${this.state.page}`;
        console.log(333, url);
